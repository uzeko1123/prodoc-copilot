...
import { commentPlugin } from '@/components/shadcn/editor/plugins/comment-kit';
import type { TDiscussion } from '@/components/shadcn/editor/plugins/discussion-kit';
import { useBlockDiscussionItems } from '@/lib/shadcn/block-discussion-index';
import { suggestionPlugin } from '@/components/shadcn/editor/plugins/suggestion-kit';
