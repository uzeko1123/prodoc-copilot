...
import type { CommentToolIO } from '../tool-comment';

export function applyComment(editor: PlateEditor, aiComment: CommentToolIO) {
...
export function applyCommentPrimitive(
  editor: PlateEditor,
